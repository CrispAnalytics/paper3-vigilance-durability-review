...
\usepackage{xurl} % better line-breaking for long URLs/DOIs
...
\newcommand{\ManuscriptTitle}{Engineering Alertness Day After Day: Durability Signals, Habituation Risks, and Evidence Gaps in Natural Protocols}
\newcommand{\RunningTitle}{Engineering alertness day after day}
...
All protocol documents, search logs, screening manifest metadata, extraction tables, synthesis outputs, and figure files used in this review are archived on Zenodo (DOI: \url{https://doi.org/10.5281/zenodo.18650391}). For convenience, a source-controlled mirror is maintained on GitHub: \url{https://github.com/CrispAnalytics/paper3-vigilance-durability-review}. Full-text PDFs are not redistributed due to copyright and licensing restrictions; the archive provides OpenAlex IDs/DOIs and extraction anchors to enable independent retrieval and audit.
