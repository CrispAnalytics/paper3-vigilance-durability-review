...
All protocol documents, search logs, screening manifest metadata, extraction tables, and synthesis outputs used in this review are available in a public repository at: \url{https://github.com/CrispAnalytics/paper3-vigilance-durability-review} (release/tag: v1.0.0). Full-text PDFs are not redistributed due to copyright and licensing restrictions; the repository provides OpenAlex IDs/DOIs and extraction anchors to enable independent retrieval and audit.
